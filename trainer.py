...
from musegan_proj_dev.gan.utils import WassersteinLoss, GradientPenalty
        ...
        for epoch in tqdm(range(epochs)):
            ...
            for real in dataloader:
                ...
                for _ in range(repeat):
                    ...
                    alpha = torch.rand((batch_size, 1, 1, 1, 1), requires_grad=True).to(self.device)
                    ...
                    penalty = self.c_penalty(real, fake, realfake_pred)
